...
public class RecepcionistaService {
    ...
    public Recepcionista salvarFuncionario(Recepcionista recepcionista) {
    ...
    public Recepcionista buscarFuncionario(Long id) {
    ...
    public Recepcionista alterarStatusFuncionario(Long id, Status status) {
